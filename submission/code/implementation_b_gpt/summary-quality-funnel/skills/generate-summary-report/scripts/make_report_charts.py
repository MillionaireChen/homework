...
OUTCOME_ORDER = [
    ...
    ("FACTUAL_REVERSAL", "Reversed", "#9B2226"),
    ("FABRICATED_CONTENT", "Fabricated", "#BB3E03"),
...
def plot_scores(rows: List[Dict[str, Any]], output: Path) -> None:
    ...
    label_order = [name for name in ("EXCELLENT", "GOOD", "FINE", "MIXED", "POOR") if label_counts.get(name)]
