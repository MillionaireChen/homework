...
def structural_metrics(text: str) -> Dict[str, Any]:
    ...
    # Only hard_truncation proposes a terminal: a trailing comma/colon or an unclosed
    # delimiter is evidence a string test can prove. Everything else is reported for the
    # Reviewer, which reads the text and decides whether the candidate stops mid-thought.
