...
<script>
const DATA = __DATA__;
const FLAG_NAME = { ref_copy:"与参考答案一致", ref_prefix:"参考答案截断版", lead_copy:"照抄原文开头", truncated:"疑似截断", clean:"无标记" };
...
function renderMain(a, hlId){
  ...
  <div class="card">
    ...
    <div class="label">参考答案(reference_summary)</div>
...
stats_parts = []
name = {"ref_copy": "同参考答案", "ref_prefix": "参考答案截断版", "lead_copy": "抄原文开头", "truncated": "疑似截断"}
