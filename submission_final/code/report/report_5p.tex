...
No human judgement is involved. Agreement therefore reflects reproducibility, not correctness. The weak-label check can also accept flawed references. Beyond grammatical completeness, the evaluation does not assess style, register, audience fit, or newsworthiness; it only checks whether the selected facts are central to the article.
