...
def main() -> None:
    ...
    parser.add_argument(
        "--article-corpus-output",
        type=Path,
        help="offline threshold-calibration corpus only. The runtime relevance gate "
        "compares a candidate with its own assigned article and never reads this file, "
        "because cross-article comparison is prohibited.",
    )
